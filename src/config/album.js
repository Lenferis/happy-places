...
export const PAGES = [
  ...
  { type: 'letter', heading: 'Как-то так...', body: [
    'Ну получилось как-то так, правда, спонтанно, после твоих вчерашних слов о архиве, поэтому о части сама виновата ахахаха, но надеюсь что тебе понравилось, не то чтоб в это было что-то сверхъестественное, однако определенный труд я все же приложил. В теории можешь воспринимать это как угодно, частично все будет правильно, но я не настаиваю ни на одном из вариантов. Не подумай ничего плохого. В целом я готов к любой твоей реакции, поэтому если хочешь, то просто промолчи, хотя опять же, повторюсь, просто захотелось, это ничего не значит(если сама этого не хочешь). Хотя в любом случае, если говорить честно, сколько я б не пиздел, за определенные моменты правда тебе благодарен, мне приятно с тобой общаться, мне хорошо с тобой общаться, и надеюсь что это взаимно, понимаю что иногда я уж излишне навязчивый, но что уж поделать, какой есть. Хотя думаю ты может и сама заметила что я стараюсь исправится как-то, потому что понимаю что у тебя свои личные границы и тому подобное. '
  ]},
  { type: 'letter', body: [
    'Не знаю как там будет дальше, но я рад что написал тебе тогда и мы возобновили общение, надеюсь что дальше - больше, и не перестанем общаться та же глупо как и в прошлый раз.'
  ]}
];

export const QUOTE_BACK = 'Использовал я, к слову,\n лишь 0,452% от всех твоих фоток)';
